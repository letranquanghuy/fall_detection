...
# VIDEO SOURCE
# video_path = 0
video_path = 'D:/HCMUT/Ths/Thesis/deep_sort/data/test9.mp4'
# video_path = 'D:/HCMUT/Ths/Thesis/deep_sort/data/3_person(1).mp4'
# video_path = "D:/HCMUT/Ths/Thesis/Evaluate/south/3/south_2_1.mp4"
# video_path = 'D:/HCMUT/Ths/Thesis/Evaluate/normal/1/normal_1.mp4'
...
ret, frame = cap.read()
y, x, _ = frame.shape
out = cv2.VideoWriter('test9.mp4',
                         cv2.VideoWriter_fourcc(*'XVID'), 
                         20, (x,y)) 
# YOLOv8
# Load model Yolov8
print(torch.cuda.is_available())
weight_path = 'D:/HCMUT/Ths/Thesis/yolov8/tensorrt/best17_1.engine'
...
while ret:
    ...
    frame = cv2.putText(frame, 'fps: '+ "%.2f"%(fps), (25, y-40), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 255, 0), 2)
